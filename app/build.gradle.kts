...
// just reads it. Falls back to null (unsigned release build) when it's missing, e.g. on a fresh
// clone before the keystore has been generated, so `assembleDebug`/sync don't break.
...
android {
    namespace = "com.example.focusmode"
    compileSdk = 35
